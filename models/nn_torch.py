...
# read in data
train_raw_df = pd.read_csv('../data/data_feature_selection/without winning rate/standardized/df_train_standarized_45_columns.csv')
test_raw_df = pd.read_csv('../data/data_feature_selection/without winning rate/standardized/df_test_standarized_45_columns.csv')
